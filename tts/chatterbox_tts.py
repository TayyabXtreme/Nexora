...
B2_BUCKET_NAME = "Nexora-Voice"
B2_ENDPOINT = "https://s3.us-east-005.backblazeb2.com"
B2_MOUNT_PATH = "/b2"

b2_bucket = modal.CloudBucketMount(
    B2_BUCKET_NAME,
    bucket_endpoint_url=B2_ENDPOINT,
    secret=modal.Secret.from_name("backblaze-b2"),
    read_only=True,
)
...
@app.cls(
    ...
    volumes={B2_MOUNT_PATH: b2_bucket},
)
...
class Chatterbox:
    ...
    def serve(self):
        ...
        def generate_speech(request: TTSRequest):
            voice_path = Path(B2_MOUNT_PATH) / request.voice_key
...
def test(
    ...
    audio_prompt_path = f"{B2_MOUNT_PATH}/{voice_key}"
