...
export function TextToSpeechDetailView({
  ...
  const customVoices = Array.isArray(voicesQuery.data.custom)
    ? voicesQuery.data.custom
    : [];
  const systemVoices = Array.isArray(voicesQuery.data.system)
    ? voicesQuery.data.system
    : [];
